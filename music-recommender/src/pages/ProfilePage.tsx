...
const ProfilePage = () => {
  ...
  if (!userProfile) {
    return (
      <div className="min-h-screen bg-radial-gradient-center text-white flex items-center justify-center">
        Loading profile...
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-radial-gradient-center text-white flex justify-center items-center p-8">
      <div className="bg-zinc-900 p-6 rounded-lg shadow-lg w-full max-w-md">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-thin text-light-blue mt-4 mb-2">
          ...
          <a
            ...
            className="text-light-orange hover:underline mt-5"
          >
            View on Spotify
          </a>
        </div>
